...
__C.DATASETS.SHAPETALK.SHAPE_TO_REMOVE      = ["lamp","speaker","rifle","watercraft", "cabinet", "car", "sofa", "telephone"]

                                            # 3- ["lamp","speaker","rifle","watercraft"]
# __C.DATASETS.SHAPETALK.SHAPE_TO_REMOVE      = ["aeroplane", "bench", "chair", "table", "display","cabinet", "car", "sofa", "telephone"] 

                                            # 4- Whole
# __C.DATASETS.SHAPETALK.SHAPE_TO_REMOVE        = []
# # Dataset
#
__C.DATASET                                 = edict()
...
__C.CONST.STATE                             = 'Test'   #"Test", 'Train_resume'
...
__C.PLOT                                    = edict()
__C.PLOT.NUM_SAMPLES                        = 3000
__C.PLOT.DATALOADER                         =  "Train" #"Test" 
__C.PLOT.GROUP                              = 2
