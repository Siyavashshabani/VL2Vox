...
from models.VL2VoxRefinner  import VL2VoxRefinner
from models.VL2VoxRefinnerU import VL2VoxRefinnerU
# os.environ["CUDA_LAUNCH_BLOCKING"] = "1"
def train_VL2VoxRefinner(cfg):
    ...
    if cfg.CONST.REFINNERTYPE =="AE":
        vlm2pix = VL2VoxRefinner(cfg, bce_loss)
    else:
        print("Load Unet refinner---------------------------------")
        vlm2pix = VL2VoxRefinnerU(cfg, bce_loss)
    ...
    for epoch_idx in range(init_epoch, cfg.TRAIN.NUM_EPOCHS):
        ...
        for batch_idx, (taxomony_class, taxonomy_names, sample_names, rendering_images,
            ...
            # print("refiner_loss --------------------------:", refiner_loss)

            # print("generated_volumes range:", generated_volumes.min(), generated_volumes.max())
