...
__C.DATASETS.SHAPETALK.TXT_PATH             = './data/shapetalk/language/shapetalk_raw_public_version_0.csv'
                                            ...
                                            # 1- "cabinet", "car", "sofa", "telephone"
# __C.DATASETS.SHAPETALK.SHAPE_TO_REMOVE      = ["aeroplane","bench", "chair","display","lamp","speaker","rifle","table","watercraft"] 

                                            # 2- "aeroplane", "bench", "chair", "table", "display"
__C.DATASETS.SHAPETALK.SHAPE_TO_REMOVE      = ["lamp","speaker","rifle","watercraft", "cabinet", "car", "sofa","aeroplane","bench","telephone", "table", "display"]

                                            # 3- ["lamp","speaker","rifle","watercraft"]
# __C.DATASETS.SHAPETALK.SHAPE_TO_REMOVE      =      ["aeroplane", "bench", "chair", "table", "display", 
#                                                   "cabinet", "car", "sofa", "telephone", "speaker","rifle", "watercraft"]
# # # # Dataset
#
__C.DATASET                                 = edict()
...
__C.CONST.DEVICE                            = '4,5,6'
# __C.CONST.DEVICE                            = '6,7,3' 
__C.CONST.RNG_SEED                          = 0
__C.CONST.IMG_W                             = 224       # Image width for input
__C.CONST.IMG_H                             = 224       # Image height for input
__C.CONST.BATCH_SIZE                        = 192
...
__C.CONST.FIRST_SENTENCE                    = True
__C.CONST.STATE                             = 'Test'   #"Train", 'Train_resume'
__C.CONST.MODEL                             = 'VLM2pix' #VLM2pix 
...
__C.NETWORK.DECODER                         = "Conv" # or Tr 
__C.Train_decoder                           = True
__C.Train_refiner                           = False
...
__C.TRAIN.FLAVA_LEARNING_RATE               = 5e-3
__C.TRAIN.DINO_LEARNING_RATE                = 5e-3
__C.TRAIN.FUSION_LEARNING_RATE              = 1e-2
__C.TRAIN.MERGER_LEARNING_RATE              = 5e-4

__C.TRAIN.DECODER_LEARNING_RATE             = 2e-5
__C.TRAIN.REFINER_LEARNING_RATE             = 2e-5
__C.TRAIN.CONVERTER_LEARNING_RATE           = 5e-3
__C.TRAIN.T_MAX                             = 600
__C.TRAIN.SCHEDULAR                         = "Cosine"  #"LR"
__C.TRAIN.ETA_MIN                           = 5e-6 #1e-7
...
__C.TEST.VISUALIZATION                      = True



## best model for group 2: ./output/checkpoints/2024-12-30T11:09:36.315772_best_group_2/checkpoint-best.pth
## best model for group 1: ./output/checkpoints/2024-12-21T15:45:58.906303_best_group1_0.7922/checkpoint-best.pth
